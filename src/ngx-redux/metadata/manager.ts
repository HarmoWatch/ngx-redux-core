...
export class MetadataManager {
  ...
  public static getActionMetadata<T>(target: T): ReduxActionDecoratorMetadata {
    return MetadataManager.get(target, MetadataManager.ACTION_KEY, {
      contextClazz: null,
      type: '',
    });
  }
  ...
  public static getActionContextMetadata<T>(target: T): ActionContextData {
    return MetadataManager.get(target, MetadataManager.ACTION_CONTEXT_KEY, {
      prefix: '',
    });
  }
  ...
  public static getReducerMetadata<T>(target: T): ReduxReducerDecoratorMetadata {
    return MetadataManager.get(target, MetadataManager.REDUCER_KEY, {
      reducers: [],
    });
  }
  ...
  public static getStateMetadata<T>(target: T): StateData {
    return MetadataManager.get(target, MetadataManager.STATE_KEY, {
      name: '',
    });
  }
